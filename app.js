...
function readPrzFilesInDirectory(directory, delete_files) {
	...
	for (var file in files) {
		readHandheldData(directory + "/" + files[file], savePackets, delete_files);
	}
}

readPrzFilesInDirectory('/Users/andrew/Downloads/test_files', false);